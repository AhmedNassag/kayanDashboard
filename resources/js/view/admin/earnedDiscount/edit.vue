...
export default {
    ...
    setup(props){
        ...
        let getMainJobViews = () => {
            ...
            adminApi.get(`/v1/dashboard/earnedDiscount/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    companies.value = l.companies;
                    addJob.data.company_id = l.earnedDiscount.company_id;
                    addJob.data.discount = l.earnedDiscount.discount;
                    addJob.data.to_date = l.earnedDiscount.to_date;
                    addJob.data.note = l.earnedDiscount.note;
                    addJob.data.purchase_id = l.earnedDiscount.purchase_id;
                })
                .catch((err) => {
    ...
    methods: {
        editJob(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/earnedDiscount/${this.id}`,this.data)
                    .then((res) => {
                        notify({
