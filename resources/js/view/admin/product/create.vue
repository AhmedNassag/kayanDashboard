                    ...
                    <div class="form-row row">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <div class="invalid-feedback">
                          ...
                          <span v-if="v$.barcode.integer.$invalid"
                            >{{ $t("global.ThisFieldMustBeANumber") }}<br
                          /></span>
                        </div>
                      </div>
                      <!--End BarCode-->
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <select
                          ...
                          :class="{
                            'is-invalid': v$.selling_methods.$error,
                            'is-valid': !v$.selling_methods.$invalid,
                          }"
                        >
                          <option
                        ...
                        <div class="invalid-feedback">
                          <span v-if="v$.selling_methods.required.$invalid"
                            >{{ $t("global.NameIsRequired") }}<br
                          /></span>
                        </div>
                      </div>
  ...
  setup() {
    ...
    let addProduct = reactive({
      data: {
        ...
        tax_id: null,
        selling_methods: [],
        alternativeDetails: [{ alternativeDetails: [], send: true }],
      },
    });
    ...
    let getProduct = () => {
      ...
      adminApi
        .get(`/v1/dashboard/product/create`)
        .then((res) => {
          let l = res.data.data;
    ...
    const rules = computed(() => {
      return {
        //
        alternativeDetail: [...alternativeDetailValidation.value],
        nameAr: {
