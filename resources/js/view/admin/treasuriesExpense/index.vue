                        ...
                        <ul role="tablist" class="nav nav-pills card-header-pills nav-justified">
                            <li class="nav-item">
                                <a href="#tab-4" data-bs-toggle="tab"
                                   class="nav-link active">{{ $t('global.ExpenseItems') }}</a>
                            </li>
                            <li class="nav-item">
                                <a href="#tab-5" data-bs-toggle="tab" class="nav-link">{{ $t('global.clientsExpense') }}</a>
                            </li>
                            <li class="nav-item">
...
export default {
    ...
    setup() {
        ...
        let getClientIncomes = (page = 1) => {
            loading.value = true;
            if (treasury_id.value > 0) {
                adminApi.get(`/v1/dashboard/treasuriesClientExpense/${treasury_id.value}?page=${page}&search=${searchClientIncomes.value}`)
                    .then((res) => {
                        let l = res.data.data;

                        clientIncomesPaginate.value = l.clientExpenses;
                        clientIncomes.value = l.clientExpenses.data;
                    })
                    .catch((err) => {
                        console.log(err.response.data);
                    })
        ...
        let getSupplierIncomes = (page = 1) => {
            loading.value = true;
            if (treasury_id.value > 0) {
                adminApi.get(`/v1/dashboard/treasuriesSupplierExpense/${treasury_id.value}?page=${page}&search=${searchSupplierIncomes.value}`)
                    .then((res) => {
                        let l = res.data.data;
                        supplierIncomesPaginate.value = l.supplierExpenses;
                        supplierIncomes.value = l.supplierExpenses.data;
                    })
                    .catch((err) => {
                        console.log(err.response.data);
                    })
        ...
        let getOwnerIncomes = (page = 1) => {
            loading.value = true;
            if (treasury_id.value > 0) {
                adminApi.get(`/v1/dashboard/treasuriesOwnerExpense/${treasury_id.value}?page=${page}&search=${searchOwnerIncomes.value}`)
                    .then((res) => {
                        let l = res.data.data;
                        ownerIncomesPaginate.value = l.ownerExpenses;
                        ownerIncomes.value = l.ownerExpenses.data;
                    })
                    .catch((err) => {
                        console.log(err.response.data);
                    })
        ...
        return {expense,getClientIncomes,getSupplierIncomes,getOwnerIncomes,ownerIncomesPaginate,ownerIncomes,searchOwnerIncomes,searchClientIncomes,searchSupplierIncomes,clientIncomesPaginate,supplierIncomesPaginate,clientIncomes,supplierIncomes,income,income_transfer,expense_transfer,amount,treasury_id,incomes,treasuries, loading, getIncome,dateFormat, search, incomesPaginate};
