            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexRefused'}">{{ $t("global.Refused") }}</router-link></li>
                            <li class="breadcrumb-item active">{{ $t("refused.EditRefused") }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="editRefused" class="needs-validation">
...
export default {
    ...
    setup(props){
        ...
        let getRefused = () => {
            ...
            adminApi.get(`/v1/dashboard/refused/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;

                    addRefused.data.refusedQuantity = l.refused.refusedQuantity;
                    addRefused.data.refusedReason = l.refused.refusedReason;
                    addRefused.data.note = l.refused.note;
                    addRefused.data.discountPercentage = l.refused.discountPercentage;
                    addRefused.data.discountValue = l.refused.discountValue;
                    addRefused.data.anotherDiscount = l.refused.anotherDiscount;
                    addRefused.data.total = l.refused.total;
                    addRefused.data.category_id = l.refused.category_id;
                    addRefused.data.supplier_id = l.refused.supplier_id;
                    addRefused.data.product_id = l.refused.product_id;
                    addRefused.data.stock_id = l.refused.stock_id;
                })
                .catch((err) => {
        ...
        //end common
        return {id,loading,...toRefs(addRefused),v$,categories,suppliers,products,stocks};
    },
    methods: {
        editRefused(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                formData.append("anotheDiscount", this.data.anotheDiscount);
                ...
                adminApi.post(`/v1/dashboard/refused/${this.id}`,formData)
                .then((res) => {
                    notify({
