                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.clientIncomes') }}</li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-2 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createClientIncomes'}"
                                            v-if="permission.includes('clientIncomes create')"
...
export default {
    ...
    setup() {
        ...
        let getIncome = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/clientIncomes?page=${page}&search=${search.value}&from_date=${fromDate.value}&to_date=${toDate.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteJob(id, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/clientIncomes/${id}`)
                        .then((res) => {
