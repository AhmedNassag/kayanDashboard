        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{$t('global.clientIncomes')}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexClientIncomes'}">{{$t('global.clientIncomes')}}</router-link></li>
                                        ...
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-4 mb-3 position-relative">
                                                ...
                                                <div class="invalid-feedback">
                                                    <span v-if="v$.client_id.required.$invalid">{{$t('global.IsRequired')}}<br /> </span>
                                                </div>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number"
                                                       class="form-control"
                                                       v-model.number="v$.order_id.$model"
                                                       :class="{'is-invalid':v$.order_id.$error,'is-valid':!v$.order_id.$invalid}"
                                                       :placeholder="$t('global.orderInvoiceNumber')"
                                                >
                                                <div class="valid-feedback">{{ $t('global.LooksGood') }}</div>
                                            </div>
...
export default {
    ...
    setup(props){
        ...
        let getData = () => {
            ...
            adminApi.get(`/v1/dashboard/clientIncomes/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    ...
                    addJob.data.notes = l.supplier.notes;
                    addJob.data.client_id = l.supplier.client_id;
                    addJob.data.income_id = l.supplier.income_id;
                    addJob.data.treasury_id = l.supplier.treasury_id;
                    addJob.data.amount = l.supplier.amount;
                    addJob.data.purchase_return_id = l.supplier.purchase_return_id;
                    addJob.data.order_id = l.supplier.order_id;
                    addJob.data.payment_date = l.supplier.payment_date;
                    let v = l.suppliers.filter((el)=> el.id == l.supplier.client_id);
                    addJob.nameSender = v[0].name ;
                    addJob.balance = v[0].sum_account;
                    addJob.search = '';
                })
                .catch((err) => {
        ...
        let searchSender = () => {
            ...
            if(addJob.search){
                ...
                let items = suppliers.value.filter(e => e.name.match(thisString) || e.id == addJob.search);
    ...
    methods: {
        editJob(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/clientIncomes/${this.id}`,this.data)
                    .then((res) => {
                        notify({
