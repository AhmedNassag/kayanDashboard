        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.showOrderReturned') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body pt-0">
                                        <div v-if="parseInt(order.order_status_id) == 7" class="card-header mb-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                        ...
                                        <table v-if="parseInt(order.order_status_id) == 7" class="table table-center table-hover mb-0 datatable">
                                            <thead>
                                            <tr>
                                                <th>#</th>
...
export default {
    ...
    setup(props) {
        ...
        let getProducts = () => {
            ...
            adminApi.get(`/v1/dashboard/orderReturned/${id.value}`)
                .then((res) => {
                    let l = res.data.data;
                    ...
                    order_return.value = l.order.order_return;
                })
                .catch((err) => {
        ...
        return {dateFormat,store_name,user,order_return,client,order,order_details, date_now, loading, permission, getProducts, search};
