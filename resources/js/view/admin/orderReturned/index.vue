        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.orderReturned') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.orderReturned') }}</li>
                        </ul>
                    </div>
                                            ...
                                            <div class="form-group row align-items-center justify-content-around">
                                                ...
                                                <div class="col-md-2 p-0">
                                                    ...
                                                    <select v-model="status" class="form-control date-input">
                                                        ...
                                                        <option value="6">{{$t('global.total return')}}</option>
                                                        <option value="7">{{$t('global.Partial return')}}</option>
                                                    </select>
                                                </div>
...
export default {
    ...
    setup() {
        ...
        let getOrder = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/orderReturned?page=${page}&search=${search.value}&status=${status.value}&order_type=${order_type.value}&order_id=${order_id.value}&from_date=${fromDate.value}&to_date=${toDate.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        return {t,ordersPaginate,search,status,order_type,printDataSmall,permission,order_id,fromDate,toDate,orders, loading,dateFormat,printData, getOrder,close};
