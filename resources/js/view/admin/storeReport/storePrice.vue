        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.storeReport') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.storeReport') }}</li>
                        </ul>
                    </div>
                                            ...
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select v-model="order" class="form-control">
                                                        <option value="desc">{{$t('global.ascSale')}}</option>
                                                        <option value="asc">{{$t('global.descSale')}}</option></select>
                                                </div>
...
export default {
    ...
    setup() {
        ...
        let getOrder = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/storeReport?from_date=${fromDate.value}&to_date=${toDate.value}&order=${order.value}`)
            .then((res) => {
                let l = res.data.data;
