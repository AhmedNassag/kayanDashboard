...
export default {
    ...
    setup(props){
        ...
        let getLead = () => {
            ...
            adminApi.get(`/v1/dashboard/leads/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    ...
                    addLead.data.seller_category_id = l.lead.seller_category_id;
                })
                .catch((err) => {
        ...
        return {t,categories,loading,...toRefs(addLead),v$};
    },
    methods: {
        editLead(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/leads/${this.id}`,this.data)
                    .then((res) => {
