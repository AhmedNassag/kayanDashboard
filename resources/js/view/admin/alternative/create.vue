                    ...
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link :to="{ name: 'indexAlternative' }">
                                    {{ $t("global.Alternative") }}
                                </router-link>
                            </li>
                            <li class="breadcrumb-item active">
                                {{ $t("alternative.CreateAlternative") }}
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link :to="{ name: 'indexAlternative' }" class="btn btn-custom btn-dark">
                                    {{ $t("global.back") }}
                                </router-link>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="storeAlternative" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-12 row flex-fill">
                                                ...
                                                <div class="container-images" id="container-images" v-show="
                                                    data.file &&
                                                    numberOfImage
                                                "></div>
    ...
    methods: {
        storeAlternative() {
            ...
            if (!this.v$.$error) {
                ...
                adminApi
                    .post(`/v1/dashboard/alternative`, formData)
                    .then((res) => {
                        notify({
