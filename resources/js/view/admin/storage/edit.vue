            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexStorage'}">{{ $t("global.Storages") }}</router-link></li>
                            <li class="breadcrumb-item active">{{ $t("storage.EditStorage") }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="editStorage" class="needs-validation">
...
export default {
    ...
    setup(props){
        ...
        let getStorage = () => {
            ...
            adminApi.get(`/v1/dashboard/storage/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;

                    addStorage.data.name = l.storage.name;
                })
                .catch((err) => {
        ...
        return {id,loading,...toRefs(addStorage),v$};
    },
    methods: {
        editStorage(){
            this.v$.$validate();
            ...
            if(!this.v$.$error) {
                ...
                adminApi.post(`/v1/dashboard/storage/${this.id}`,formData)
                .then((res) => {
                    notify({
