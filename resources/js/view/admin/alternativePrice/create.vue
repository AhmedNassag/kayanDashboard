                    ...
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexAlternativePrice'}">{{ $t("global.Alternative Price") }}</router-link>
                            </li>
                            <li class="breadcrumb-item active">{{ $t("price.CreateAlternativePrice") }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link :to="{name: 'indexAlternativePrice'}" class="btn btn-custom btn-dark">{{ $t("global.back") }}</router-link>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="storeAlternativePrice" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <Select2 v-model.trim="v$.alternative_id.$model" :options="products" :settings="{ width: '100%' }" />
...
export default {
    ...
    setup(){
        ...
        let getAlternativePrice= () => {
            ...
            adminApi.get(`/v1/dashboard/alternativePrice/create`)
                .then((res) => {
                    let l = res.data.data;
    ...
    methods: {
        ...
        storeAlternativePrice(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/alternativePrice`,formData)
                    .then((res) => {
