...
export default {
    ...
    setup(props){
        ...
        let getData = () => {
            ...
            adminApi.get(`/v1/dashboard/purchaseInvoice/${id.value}/edit`)
                .then((res) => {
                    ...
                    addJob.data.discount_percentage = l.purchase.discount_percentage;
                    addJob.data.discount_value = l.purchase.discount_value;
                    addJob.data.other_discounts = l.purchase.other_discounts;
                    addJob.data.transfer_price = l.purchase.transfer_price;
        ...
        return {t,validateLTE,validateExpiryDate,validateProductionDate,getProduct,getMeasurementUnit,getSubCategory,loading,...toRefs(addJob),v$,DebitAmount,categories,suppliers,stores,totalProductQuantity,totalProductPrice,productValidation};
    },
    methods: {
        storeJob(){
            this.v$.$validate();
