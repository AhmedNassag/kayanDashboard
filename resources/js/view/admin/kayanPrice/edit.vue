            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexKayanPrice'}">{{ $t("global.Kayan Price") }}</router-link></li>
                            <li class="breadcrumb-item active">{{ $t("kayanPrice.EditKayanPrice") }}</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    methods: {
        ...
        editKayanPrice(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/kayanPrice/${this.id}`,formData)
                .then((res) => {
