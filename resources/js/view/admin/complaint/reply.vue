                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t("complaint.ReplyComplaint") }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-7 mb-3">
                                                ...
                                                <textarea type="text" class="form-control custom-textarea" cols="10" rows="10"
                                                    ...
                                                    id="validationCustom034"
                                                    :placeholder="$t('global.Add Reply')"
                                                    :class="{'is-invalid':v$.reply.$error,'is-valid':!v$.reply.$invalid}"
                                                ></textarea>
                                            </div>
                                            <!--End Reply-->
    ...
    methods: {
        replyComplaint(){
            ...
            if(!this.v$.$error) {
                ...
                formData.append('reply',this.data.reply);
                // formData.append('_method','PUT');

                adminApi.post(`/v1/dashboard/replycomplaint/${this.id}`,formData)
                .then((res) => {
                    notify({
