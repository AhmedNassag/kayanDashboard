                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.PurchaseInvoice') }}</li>
                        </ul>
                    </div>
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-2 row justify-content-end">
                                        <router-link v-if="permission.includes('PurchaseInvoice create')"
                                            :to="{name: 'createPurchaseInvoice', params: {lang: locale || 'ar'}}"
...
export default {
    ...
    setup() {
        ...
        function deleteJob(id, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/purchaseInvoice/${id}`)
                        .then((res) => {
        ...
        return {purchasesPaginate,search,permission,purchase_id,fromDate,toDate,purchases, loading,deleteJob,dateFormat,printData, getIncome,close};
