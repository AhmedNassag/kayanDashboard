                                    ...
                                    <form @submit.prevent="storeJob" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-4 mb-3"  hidden>
                                                ...
                                                <select v-model="data.type_invoice" :class="['form-control',{'is-invalid':v$.type_invoice.$error,'is-valid':!v$.type_invoice.$invalid}]">
...
export default {
    ...
    setup(){
        ...
        let subPrice = (index)=>{
            // console.log(addJob.data.product[index].sub_price,addJob.data.product[index].sub_price.toFixed(2))
