        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.showOrderOnline') }}</h3>
                        <ul class="breadcrumb">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="card-header mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <h5>{{$t('global.discountValue')}} : {{ order.discount }} {{ order.currency }}</h5>
                                                </div>
                                                    ...
                                                    <h5>
                                                        ...
                                                        {{
                                                            order.order_other_offer?
                                                                parseFloat( order.sub_total - order.order_other_offer.offer - order.discount).toFixed(2) :
                                                                parseFloat( order.sub_total - order.discount).toFixed(2)
                                                        }}
                                                        {{ order.currency }}
                                                    </h5>
                                                </div>
...
export default {
    ...
    setup(props) {
        ...
        let getProducts = () => {
            ...
            adminApi.get(`/v1/dashboard/orderOnline/${id.value}`)
                .then((res) => {
                    let l = res.data.data;
