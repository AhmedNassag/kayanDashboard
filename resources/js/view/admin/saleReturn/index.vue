                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <div class="head-data row">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        ...
                                                                                        <p>{{$t('global.TotalPriceBeforeDiscount')}} : {{ item.sale.price }} ج.م</p>
                                                                                        <p>{{$t('global.discountPercentage')}} : {{ item.sale.discount_percentage }} %</p>
                                                                                    </div>
                                                                                    <div class="col-md-6">
                                                                                        <p>{{$t('global.discountValue')}} : {{ item.sale.discount_value }} ج.م</p>
                                                                                        <p>{{$t('global.otherDiscounts')}} : {{ item.sale.other_discounts }} ج.م</p>
                                                                                        <p>{{$t('global.transferPrice')}} : {{ item.sale.transfer_price }} ج.م</p>
                                                                                        <p>{{$t('global.TotalPriceAfterDiscount')}} : {{ item.sale.total_price }} ج.م</p>
                                                                                    </div>
                                                                                </div>
                                                                                <table class="table table-center table-hover mb-0 datatable">
                                                                                    <thead>
