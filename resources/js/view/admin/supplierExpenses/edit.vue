        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{$t('global.supplierExpenses')}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexSupplierExpenses'}">{{$t('global.supplierExpenses')}}</router-link></li>
...
export default {
    ...
    setup(props){
        ...
        let getData = () => {
            ...
            adminApi.get(`/v1/dashboard/supplierExpense/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    ...
                    addJob.data.supplier_id = l.supplier.supplier_id;
                    ...
                    let v = l.suppliers.filter((el)=> el.id == l.supplier.supplier_id);
    ...
    methods: {
        editJob(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/supplierExpense/${this.id}`,this.data)
                    .then((res) => {
                        notify({
