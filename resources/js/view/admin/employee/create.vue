            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm">
                  ...
                  >
                    {{ errors["bank_name"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['bank_address']"
                  >
                    {{ errors["bank_address"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['bank_iban']"
                  >
                    {{ errors["bank_iban"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['bank_swift']"
                  >
                    {{ errors["bank_swift"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['name']"
                  ...
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['confirmtion']"
                  >
                    {{ errors["confirmtion"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['department_id']"
                  >
                    {{ errors["department_id"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['job_id']"
                  ...
                  >
                    {{ errors["National_ID"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['birth_date']"
                  >
                    {{ errors["birth_date"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['hiring_date']"
                  >
                    {{ errors["hiring_date"][0] }}<br />
                  </div>
                  <div
                    class="alert alert-danger text-center"
                    v-if="errors['salary']"
                    ...
                    <div class="form-row row">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input
                          ...
                          :class="{
                            'is-invalid': v$.National_ID.$error,
                            'is-valid': !v$.National_ID.$invalid,
                          }"
                        ...
                        <div class="invalid-feedback">
                          <span v-if="v$.National_ID.required.$invalid"
                            >{{ $t("global.NationalIdIsRequired") }} <br
                          /></span>
                          <span v-if="v$.National_ID.minLength.$invalid"
                            >{{ $t("global.NationalIdIsMustHaveAtLeast") }}
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input
                          ...
                          :class="{
                            'is-invalid': v$.hiring_date.$error,
                            'is-valid': !v$.hiring_date.$invalid,
                          }"
                        ...
                        <div class="invalid-feedback">
                          <span v-if="v$.hiring_date.required.$invalid"
                            >{{ $t("global.HiringDateIsRequired") }} <br
                          /></span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input
                          ...
                          :class="{
                            'is-invalid': v$.birth_date.$error,
                            'is-valid': !v$.birth_date.$invalid,
                          }"
                        ...
                        <div class="invalid-feedback">
                          <span v-if="v$.birth_date.required.$invalid"
                            >{{ $t("global.BirthDateIsRequired") }} <br
                          /></span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <div class="invalid-feedback">
                          <span v-if="v$.salary.required.$invalid"
                            >{{ $t("global.SalaryIsRequired") }} <br
                          /></span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <select
                          ...
                          :class="[
                            'form-select',
                            {
                              'is-invalid': v$.department_id.$error,
                              'is-valid': !v$.department_id.$invalid,
                            },
                          ]"
                        >
                          <option
                        ...
                        <div class="invalid-feedback">
                          <span v-if="v$.department_id.required.$invalid"
                            >{{ $t("global.DepartmentIsRequired") }}<br />
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12 mb-12">
                        ...
                        <select
                          ...
                          :class="[
                            'form-select',
                            {
                              'is-invalid': v$.job_id.$error,
                              'is-valid': !v$.job_id.$invalid,
                            },
                          ]"
                        >
                          <option
                        ...
                        <div class="invalid-feedback">
                          <span v-if="v$.job_id.required.$invalid"
                            >{{ $t("global.JobIsRequired") }}<br />
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 mb-3 mt-5">
                        <div class="sec-body">
                          ...
                          <div class="col-md-12 mb-12">
                            ...
                            <div class="invalid-feedback">
                              <span v-if="v$.bank_name.required.$invalid"
                                >{{ $t("global.BankNameIsRequired") }} <br
                              /></span>
                              <span v-if="v$.bank_name.minLength.$invalid"
                                >{{ $t("global.BankNameIsMustHaveAtLeast") }}
                                {{ v$.bank_name.minLength.$params.min }}
                                {{ $t("global.Letters") }} <br
                              /></span>
                              <span v-if="v$.bank_name.maxLength.$invalid"
                                >{{ $t("global.BankNameIsMustHaveAtMost") }}
                          ...
                          <div class="col-md-12 mb-12">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid': v$.bank_address.$error,
                                'is-valid': !v$.bank_address.$invalid,
                              }"
                            ...
                            <div class="invalid-feedback">
                              <span v-if="v$.bank_address.required.$invalid"
                                >{{ $t("global.BankAddressIsRequired") }} <br
                              /></span>
                              <span v-if="v$.bank_address.minLength.$invalid"
                                >{{ $t("global.BankAddressIsMustHaveAtLeast") }}
                                {{ v$.bank_address.minLength.$params.min }}
                                {{ $t("global.Letters") }} <br
                              /></span>
                              <span v-if="v$.bank_address.maxLength.$invalid"
                                >{{ $t("global.BankAddressIsMustHaveAtMost") }}
                          ...
                          <div class="col-md-12 mb-12">
                            ...
                            <div class="invalid-feedback">
                              <span v-if="v$.bank_iban.required.$invalid"
                                >{{ $t("global.IBANIsRequired") }} <br
                              /></span>
                              <span v-if="v$.bank_iban.minLength.$invalid"
                                >{{ $t("global.IBANIsMustHaveAtLeast") }}
                                {{ v$.bank_iban.minLength.$params.min }}
                                {{ $t("global.Letters") }} <br
                              /></span>
                              <span v-if="v$.bank_iban.maxLength.$invalid"
                                >{{ $t("global.IBANIsMustHaveAtMost") }}
                          ...
                          <div class="col-md-12 mb-12">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid': v$.bank_swift.$error,
                                'is-valid': !v$.bank_swift.$invalid,
                              }"
                              placeholder="swift"
                            />
                          </div>
                          ...
                          <div class="col-md-12 mb-12">
                            ...
                            <select
                              ...
                              :class="[
                                'form-select',
                                {
                                  'is-invalid': v$.role_name.$error,
                                  'is-valid': !v$.role_name.$invalid,
                                },
                              ]"
                            >
                              <option
                          ...
                          <div class="col-md-12 mb-12">
                            ...
                            <div class="invalid-feedback">
                              <span v-if="v$.password.required.$invalid"
                                >{{ $t("global.PasswordIsRequired") }}<br />
                              </span>
                          ...
                          <div class="col-md-12 mb-12">
                            ...
                            <input
                              ...
                              :class="[
                                'form-control',
                                {
                                  'is-invalid': v$.confirmtion.$error,
                                  'is-valid': !v$.confirmtion.$invalid,
                                },
                              ]"
                            ...
                            <div class="invalid-feedback">
                              <span v-if="v$.confirmtion.required.$invalid"
                      ...
                      <div class="col-md-12 mb-12 row flex-fill">
                        ...
                        <span class="text-danger text-center" v-if="requiredn"
                          >{{ $t("global.ImagesIsMustHaveAtLeast1Photos") }}<br
                        /></span>
                        <div
...
export default {
  ...
  setup() {
    ...
    let getMainDepartmentViews = () => {
      ...
      adminApi
        .get(`/v1/dashboard/activeDepartment`)
        .then((res) => {
          let l = res.data.data;
  ...
  methods: {
    storeEmployee() {
      ...
      if (!this.v$.$error) {
        ...
        adminApi
          .post(`/v1/dashboard/employee`, formData)
          .then((res) => {
            notify({
              title: `${this.t(
