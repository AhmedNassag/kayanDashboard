...
export default {
    ...
    setup(props){
        ...
        return {t,validateLTE,getProduct,getMeasurementUnit,getSubCategory,loading,...toRefs(addJob),v$,DebitAmount,categories,clients,stores,totalProductQuantity,totalProductPrice,productValidation};
    },
    methods: {
        storeJob(){
            this.v$.$validate();
