        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.productReport') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.productReport') }}</li>
                        </ul>
                    </div>
                                            ...
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select v-model="order" class="form-control">
                                                        <option value="desc" selected>{{$t('global.ascSale')}}</option>
                                                        <option value="asc">{{$t('global.descSale')}}</option>
                                                    </select>
                                                </div>
...
export default {
    ...
    setup() {
        ...
        let getOrder = (page = 1) => {
            loading.value = true;
            adminApi.get(`/v1/dashboard/productReport?from_date=${fromDate.value}&to_date=${toDate.value}&order=${order.value}`)
            .then((res) => {
                let l = res.data.data;
        ...
        return {products,permission, loading,fromDate,toDate,getOrder,order};
