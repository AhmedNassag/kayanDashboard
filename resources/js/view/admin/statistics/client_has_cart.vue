    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col">
            <h3 class="page-title">{{ $t("global.clientHasCart") }}</h3>
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">{{ $t("global.clientHasCart") }}</li>
            </ul>
          </div>
        </div>
      </div>
                ...
                <table class="table mb-0">
                  <thead>
                    <tr>
                      ...
                      <th>{{ $t("global.Last update of the cart") }}</th>
                    </tr>
                  </thead>
...
export default {
  setup() {
    ...
    const getClients = async(page = 1 ) => {
      adminApi.get(`/v1/dashboard/get_client_has_cart?page=${page}&search=${search.value}`).then((response) => {
