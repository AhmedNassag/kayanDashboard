          ...
          <div class="col">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">
                {{ $t("pharmacistForm.CreatePharmacistForm") }}
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm">
                  ...
                  <form
                    @submit.prevent="storePharmacistForm"
...
export default {
  ...
  setup() {
    ...
    return { loading, ...toRefs(addPharmacistForm), v$ };
  ...
  methods: {
    storePharmacistForm() {
      ...
      if (!this.v$.$error) {
        ...
        adminApi
          .post(`/v1/dashboard/pharmacistForm`, formData)
          .then((res) => {
            notify({
