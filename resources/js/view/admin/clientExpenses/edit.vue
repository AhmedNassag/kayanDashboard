            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexClientExpenses'}">{{$t('global.clientExpenses')}}</router-link></li>
                                    ...
                                    <form @submit.prevent="editJob" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number"
                                                       class="form-control"
                                                       v-model.number="v$.purchase_id.$model"
                                                       :class="{'is-invalid':v$.purchase_id.$error,'is-valid':!v$.purchase_id.$invalid}"
...
export default {
    ...
    setup(props){
        ...
        let getData = () => {
            ...
            adminApi.get(`/v1/dashboard/clientExpense/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    suppliers.value = l.suppliers;
                    expenses.value = l.expenses;
        ...
        let searchSender = () => {
            ...
            if(addJob.search){
                ...
                let items = suppliers.value.filter(e => e.user.name.match(thisString) || e.id == addJob.search);
    ...
    methods: {
        editJob(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/clientExpense/${this.id}`,this.data)
                    .then((res) => {
                        notify({
