<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" v-if="crm">
                                <router-link :to="{name: 'indexLead', params: {lang: locale || 'ar',id:crm}}">
                                    {{ $t('global.Leads') }}
                                </router-link>
                            </li>
                            <li class="breadcrumb-item active">{{ $t('global.Comments') }}</li>
                        </ul>
                    </div>
            ...
            <!-- /Table -->
            <!-- start Pagination -->
            <Pagination :data="commentsPaginate" @pagination-change-page="getLead">
                <template #prev-nav>
...
export default {
    ...
    setup(props) {
        ...
        return {comments,permission,crm, loading,id, getLead,dateFormat, search, deleteLead, commentsPaginate,close,printData};
