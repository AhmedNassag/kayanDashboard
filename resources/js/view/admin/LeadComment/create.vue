            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexLeadComment', params: {lang: locale || 'ar',id}}">{{$t('global.Comments')}}</router-link></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexLeadComment', params: {lang: locale || 'ar',id}}"
    ...
    methods: {
        storeLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/leadComment`,this.data)
                    .then((res) => {
