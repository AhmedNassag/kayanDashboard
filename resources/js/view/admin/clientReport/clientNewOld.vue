        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.clientOldNew') }}</h3>
                        <ul class="breadcrumb">
                                            ...
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select v-model="order" class="form-control">
                                                        <option value="">{{$t('global.allClient')}}</option>
                                                        <option value="MOBILE">{{$t('global.mobileClient')}}</option>
                                                        <option value="WEB">{{$t('global.webClient')}}</option>
                                                        <option value="DIRECT_SALE">{{$t('global.directClient')}}</option>
                                                    </select>
                                                </div>
...
<!--                                        <input type="search" v-model="search" class="custom"/>-->
        ...
        <!-- start Pagination -->
        <Pagination :limit="2" :data="paginateClients" @pagination-change-page="getOrder">
            <template #prev-nav>
...
export default {
    ...
    setup() {
        ...
        return {paginateClients,clients,permission, loading,fromDate,toDate,getOrder,order};
