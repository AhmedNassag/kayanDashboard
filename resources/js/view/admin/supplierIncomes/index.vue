                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.SupplierIncomes') }}</li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-2 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createSupplierIncomes'}"
                                            v-if="permission.includes('SupplierIncomes create')"
                                        ...
                                        <tr v-for="(item,index) in purchases"  :key="item.id">
                                            ...
                                            <td>
                                                ...
                                                <a href="#" @click="deleteJob(item.id,index)"
                                                   v-if="permission.includes('SupplierIncomes delete') && item.supplier_account"
...
export default {
    ...
    setup() {
        ...
        let getIncome = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/SupplierIncomes?page=${page}&search=${search.value}&from_date=${fromDate.value}&to_date=${toDate.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteJob(id, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/SupplierIncomes/${id}`)
                        .then((res) => {
