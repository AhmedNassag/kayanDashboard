                        ...
                        <div class="card-body">
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            v-if="permission.includes('treasury create')"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tbody v-else>
                                        <tr>
                                            <th class="text-center" colspan="6">{{$t('treasury.NoDataFound')}}</th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
export default {
    ...
    setup() {
        ...
        function activationIncome(id, incomeName, active,index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.get(`/v1/dashboard/activationTreasury/${id}`)
                        .then((res) => {
                            Swal.fire({
                                icon: 'success',
        ...
        return {treasuries, loading,permission, getTreasuries,dateFormat,activationIncome, search, deleteTreasury, treasuriesPaginate};
