        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t("global.SaleMethod") }}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexSaleMethod'}">{{ $t("global.SaleMethod") }}</router-link></li>
                            <li class="breadcrumb-item active">{{ $t("usersCategory.EditSaleMethod") }}</li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    setup(props){
        ...
        //Commons
        function getSaleMethods(){
            adminApi
                .get(`/v1/dashboard/getSaleMethods`)
                .then((res) => {
                    saleMethods.value =res.data.data.saleMethods ;
                })
                .catch((err) => {
        ...
        return {id, loading, ...toRefs(addSaleMethod), v$, saleMethods};
    },
    methods: {
        editSaleMethod(){
            this.v$.$validate();
