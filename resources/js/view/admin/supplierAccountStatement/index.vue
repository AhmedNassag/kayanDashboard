        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.supplierAccountStatement') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.supplierAccountStatement') }}</li>
                        </ul>
                    </div>
...
export default {
    ...
    setup() {
        ...
        let getData = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/SupplierAccountStatement/${supplier_id.value}?page=${page}&from_date=${fromDate.value}&to_date=${toDate.value}`)
                .then((res) => {
                    let l = res.data.data;
