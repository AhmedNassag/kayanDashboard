                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('sidebar.OrderDirect') }}</li>
                        </ul>
                    </div>
...
<!--                                        <input type="search" v-model="search" class="custom"/>-->
                                    ...
                                    <div class="col-md-2 row justify-content-end">
                                        <router-link v-if="permission.includes('order read')"
                                        ...
                                        <tr v-for="(item,index) in orders"  :key="item.id">
                                            ...
                                            <td>
                                                ...
                                                >
                                                    ...
                                                    {{$t('global.orderStatus')}}
                                                </a>

                                                <a href="#" @click="deleteOrder(item.id,index)"
                                                   v-if="permission.includes('order delete') && !(parseInt(item.order_status_id) == 5)"
                                                                        ...
                                                                        <div role="tabpanel" :id="'tab-4-'+item.id" class="tab-pane fade active show">
                                                                            ...
                                                                            <div class="row justify-content-between">
                                                                                ...
                                                                                <div class="col-4 d-flex w-25 justify-content-end">
                                                                                    <router-link @click="close(item.id)" v-if="permission.includes('order edit') && !(parseInt(item.order_status_id) == 5)"
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <p>
                                                                                            ...
                                                                                            {{
                                                                                                ...
                                                                                                parseFloat( item.sub_total - item.order_other_offer.offer - item.discount_offer).toFixed(2) :
                                                                                                parseFloat( item.sub_total - item.discount_offer).toFixed(2)
                                                                                            }}
                                                                                            {{ item.currency }}
                                                                                        </p>
...
<script>
import {onMounted,toRefs, inject, watch, ref, computed, reactive} from "vue";
...
export default {
    ...
    setup() {
        ...
        let receiveOrder = (id,index) => {
            adminApi.get(`/v1/dashboard/orderDirectStatus/${id}`)
                .then((res) => {
                    orders.value[index]['order_status_id'] =  1;

                    Swal.fire({
                        icon: 'success',
                        title: `${t("treasury.EditSuccessfully")}`,
        ...
        let accountOrderAmount = () =>{
            ...
            if (changeStatus.data.order_status_id == 7){
                ...
                changeStatus.data.products.forEach((el,index) =>{
                    ...
                    total +=   el.sub_quantity * el.sub_price;

                });
                order_amount.value = total;
