            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexPurchase'}">{{ $t("global.Purchase") }}</router-link></li>
                            <li class="breadcrumb-item active">{{ $t("purchase.EditPurchase") }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="editPurchase" class="needs-validation">
...
export default {
    ...
    setup(props){
        ...
        let getPurchase = () => {
            ...
            adminApi.get(`/v1/dashboard/purchase/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;

                    addPurchase.data.enteredQuanitity = l.purchase.enteredQuanitity;
                    addPurchase.data.refusedQuantityproductCase = l.purchase.refusedQuantityproductCase;
                    addPurchase.data.productCase = l.purchase.productCase;
                    addPurchase.data.productionDate = l.purchase.productionDate;
                    addPurchase.data.expirationDate = l.purchase.expirationDate;
                    addPurchase.data.price = l.purchase.price;
                    addPurchase.data.total = l.purchase.total;
                    addPurchase.data.category_id = l.purchase.category_id;
                    addPurchase.data.supplier_id = l.purchase.supplier_id;
                    addPurchase.data.product_id = l.purchase.product_id;
                    addPurchase.data.employee_id = l.purchase.employee_id;
                })
                .catch((err) => {
        ...
        //end common
        return {id,loading,...toRefs(addPurchase),v$,categories,suppliers,products,employees};
    },
    methods: {
        editPurchase(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/purchase/${this.id}`,formData)
                    .then((res) => {
                        notify({
