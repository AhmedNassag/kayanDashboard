        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.IncomesPurchaseReturn') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.IncomesPurchaseReturn') }}</li>
                        </ul>
                    </div>
                                                                            ...
                                                                            <div class="table-responsive" :id="'printData-'+item.id">
                                                                                <div class="head-data row">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        ...
                                                                                        <p>{{$t('global.Supplier')}} : {{ item.purchase_return.sender_name }}</p>
                                                                                    </div>
                                                                                    <div class="col-md-6">
                                                                                        <p v-if="item.note">{{$t('global.NotesReturn')}} : {{ item.note ?? ''}} </p>
                                                                                        <p>{{$t('global.TotalPrice')}} : {{ item.purchase_return.total_price }} ج.م</p>
                                                                                    </div>
...
export default {
    ...
    setup() {
        ...
        let getIncome = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/purchaseReturnAccount?page=${page}&search=${search.value}&from_date=${fromDate.value}&to_date=${toDate.value}&purchase_return_id=${purchase_return_id.value}&is_suppler=${is_suppler.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        return {purchasesPaginate,search,permission,is_suppler,purchase_return_id,fromDate,toDate,purchases, loading,dateFormat,printData, getIncome,close};
