                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-12 row mt-3">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <b>{{ $t('global.Total Amount') }} : </b> {{ incomeAndExpense_sum }}
                                        </div>
...
export default {
    ...
    setup() {
        ...
        let treasury_id = ref('');
        let incomeAndExpense_sum = ref(0);
        let fromDate = ref('');
        let toDate = ref('');
        ...
        let getIncome = (page = 1) => {
           ...
           adminApi.get(`/v1/dashboard/incomePlatformReport?page=${page}&search=${search.value}&income_id=${treasury_id.value}&from_date=${fromDate.value}&to_date=${toDate.value}`)
               .then((res) => {
                   ...
                   incomeAndExpense_sum.value = l.incomeAndExpense_sum;
        ...
        return {printExpense,fromDate,toDate,getByDate,incomeAndExpense_sum,incomes,treasuries,treasury_id,loading, getIncome,dateFormat, search, incomesPaginate};
