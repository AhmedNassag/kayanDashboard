...
class AuthDashboardController extends Controller
{
    ...
    public function authorizeUser()
    {
        ...
        if ($user) {
            $premission =  PermissionResource::collection((auth()->guard('api')->user()->getAllPermissions()));
            return  $this->sendResponse(['success' => true, "permission" => $premission], 'Data exited successfully');
        } else {
